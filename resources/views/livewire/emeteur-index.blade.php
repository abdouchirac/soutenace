            ...
            <div class="d-block mb-4 mb-md-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">emeteur</li>
                    </ol>
                </nav>
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="border-gray-200">noms de l'emeteur</th>
                        <th class="border-gray-200">action</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($emet as $emeteur)

                    <!-- Item -->
                    <tr>
                        <td>
                            <a href="#" class="fw-bold"  render="row">{{ $emeteur->id }}
                            </a>
                        </td>
                        <td>
                            <span class="fw-normal">{{$emeteur->emeteur_noms}}</span>
                        </td>
