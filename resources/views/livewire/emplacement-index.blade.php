        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th class="border-gray-200">noms de l'emplacement</th>
                    <th class="border-gray-200">detail de l'emplacement</th>
                    <th class="border-gray-200">action</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($empla as $emplacement)

                <!-- Item -->
                <tr>
                    <td>
                        <a href="#" class="fw-bold"  render="row">{{ $emplacement->id }}
                        </a>
                    </td>
                    <td>
                        <span class="fw-normal">{{$emplacement->emplacement_noms}}</span>
                    </td>
                    <td><span class="fw-bold">{{$emplacement->emplacement_detail}}</span></td>
